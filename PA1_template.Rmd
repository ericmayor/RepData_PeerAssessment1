...
paste("The mean number of steps by day is: ",mean(byDay), " and the median is: ", median(byDay))
...
paste("The interval starting at the following minute has the maximum number of steps:", names(which.max(stepsByInterval)))
```
...
par(mfrow=c(2,1))
plot(tapply(ofweekends$steps,ofweekends$interval,mean), type = "l", main = "weekend", xlab = "interval", ylab = "number of steps")
plot(tapply(ofweekdays$steps,ofweekdays$interval,mean), type = "l", main = "weekend", xlab = "interval", ylab = "number of steps")
